...
const erratanomiconDisplayOrder = [
...
const erratanomiconDisplayRank =
    new Map(
        erratanomiconDisplayOrder.map(
            (slug,index) => [
                slug,
                index
            ]
...
if(
    ...
    /*
        If nothing valid exists even in
        the graveyard, there really is
        no replacement.
    */
    ...
    /*
        Score returning characters using
        the same similarity system.
    */
